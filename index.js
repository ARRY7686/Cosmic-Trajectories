...
const material = new THREE.MeshPhongMaterial({
  map: loader.load("./textures/earthmap1k.png"),
  specularMap: loader.load("./textures/earthspec1k.png"),
  bumpMap: loader.load("./textures/earthbump1k.png"),
  bumpScale: 0.04,
});
...
const lightsMat = new THREE.MeshBasicMaterial({
  map: loader.load("./textures/earthlights1k.png"),
...
const cloudsMat = new THREE.MeshStandardMaterial({
  map: loader.load("./textures/earthcloudmap.png"),
  transparent: true,
  opacity: 0.8,
  blending: THREE.AdditiveBlending,
  alphaMap: loader.load('./textures/earthcloudmaptrans.png'),
  // alphaTest: 0.3,
});
...
function createSatellite(longitude, latitude, height, inclination, name) {
  const imageUrl = './textures/stars/circle.png'; 
